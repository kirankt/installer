	...
	cases := []struct {
	...
	}{
		{
			...
			platform: &baremetal.Platform{
				...
				BootstrapOSImage:        "http://192.168.111.1/images/qemu.x86_64.qcow2.gz",
				ClusterOSImage:          "http://192.168.111.1/images/metal.x86_64.qcow2.gz",
			},
			network: network,
		},
		{
		...
		},
		{
			...
			platform: &baremetal.Platform{
				...
				ExternalBridge:          "br0",
				ProvisioningBridge:      "br1",
				BootstrapOSImage:        "bad-url",
				ClusterOSImage:          "http://192.168.111.1/images/metal.x86_64.qcow2.gz",
			},
			network:  network,
			expected: "Invalid Value: \"bad-url\": invalid URI \"bad-url\" (no scheme)",
		},
		{
